package ZwiazekNauczycielstwaPolskiego.SelectingData;
...
public class SelectDataChooser {
    ...
    @FXML
    private void selectSalariesHandler (MouseEvent mouseEvent) {
        query = "CALL selectSalaries ()";
        selectedDataViewer = new SelectedDataViewer(query, this);
    }
